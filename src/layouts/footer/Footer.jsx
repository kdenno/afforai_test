...
export function Footer() {
    ...
    const columns = footerColumnLinks.map((col) => {
        ...
        return (
            <div key={col.heading}>
                <Typography variant='smallHeadline400' sx={{color: 'rgb(17, 17, 17)'}} >
                    {col.heading}
                </Typography>
                {
                    col.links.map((lnk) => {
        ...
        <div className={styles['wrapper']}>
             <div className={styles['slot1']}>
                ...
                <div style={{paddingRight:'50px', marginTop: '10px', marginBottom: '10px'}}>
                    <Typography variant='titleSmall400' sx={{color: 'rgb(82, 82, 82)', lineHeight: "5px"}}>
                ...
                <div style={{marginBottom: '20px'}}>
                    ...
                    <picture aria-label="top-post-badge"> 
                        ...
                        <img src="/images/top-post-badge.svg" height="42" width="195" alt="top-post-badge" />
                    </picture>
                ...
                <div style={{marginTop: '10px'}}>
                    ...
                    <picture aria-label="top-post-badge"> 
                        ...
                        <img src="/images/sputnikatx.png" height="46" width="137" alt="top-post-badge" />
                    </picture>
