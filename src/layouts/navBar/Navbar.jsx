    ...
    return (
      <li key={lnk.label}>
        {isExternalLink ? (
          ...
          >
            <Typography variant="titleSmall500">{lnk.label}</Typography>
          </a>
        ) : (
          <LinkElement to={lnk.to} anchor={anchor} aria-label={`${lnk.label}`}>
            <Typography variant="titleSmall500">{lnk.label}</Typography>
          </LinkElement>
        )}
      </li>
          ...
          <div className={styles["desktopMenu"]}>
            ...
            <div className={styles["navActions"]}>
              ...
              <div
                ...
                style={{
                  border: `solid 1px ${
                    showMobileMenu ? "rgb(96, 4, 255)" : "rgb(209, 213, 219)"
                  }`,
                }}
