      ...
      <ContentWrapper>
        ...
        <ContentContainer>
          <Gap className={styles["accuracySection"]} sx={{ maxWidth: "550px" }}>
            <Gap height="50px">
              <ButtonBadge
                badgeText="10x your productivity"
                ...
                slotAB: {
                  AB1: (
                    <Card
                      title={card3.title}
                      imgSrc={card3.imgSrc}
                      caption={card3.caption}
                    />
                  ),
                  AB2: (
                    <Card
                      sx={{ marginTop: "20px", paddingBottom: "4px" }}
                      title={card5.title}
                      imgSrc={card5.imgSrc}
                      caption={card5.caption}
                    />
                  ),
                },
                slotA: (
          ...
          <Gap className={styles["accuracySection"]} sx={{ maxWidth: "800px" }}>
            ...
            <Gap
              className={styles["accuracySection"]}
              sx={{ maxWidth: "500px" }}
            >
              <Typography variant="smallHeadline300">
                We pride ourselves on the quality of our chatbot’s responses,
                and go the extra mile to ensure the accuracy & reliability of
                our answers.
              </Typography>
            </Gap>
          </Gap>
            ...
            <Slots
              slots={{
                slotA: (
                  <Card
                    title={AScard1.title}
                    imgSrc={AScard1.imgSrc}
                    caption={AScard1.caption}
                  />
                ),
                slotB: (
                  <Card
                    title={AScard2.title}
                    imgSrc={AScard2.imgSrc}
                    caption={AScard2.caption}
                  />
                ),
                slotC: (
                  <Card
                    title={AScard3.title}
                    imgSrc={AScard3.imgSrc}
                    caption={AScard3.caption}
                  />
                ),
              }}
            />
